                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{$productDetails['name']}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Selling Price:</label>
                                            <input type="text" class="form-control" id="recipient-name" name="sellingPrice" value="{{$productDetails['sellingPrice']}}"  required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Purchase Price:</label>
                                            <input type="text" class="form-control" id="recipient-name" name="purchasePrice"  value="{{$productDetails['purchasePrice']}}"  required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="recipient-name" name ="includeShipping" value="{{$productDetails['includeShipping']}}"  required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">unit Measure:</label>
                                            <input type="text" class="form-control" id="recipient-name" name="unitMeasure"  value="{{$productDetails['unitMeasure']}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">unit:</label>
                                            <input type="text" class="form-control" id="recipient-name" name="unit" value="{{$productDetails['unit']}}"  required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">Product-Status:</label>
                                            <select class="form-control" id="exampleSelectProductStatus" name="productStatus"  value="" required>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="recipient-name" name="pictureLink" value="{{$productDetails['pictureLink']}}"  required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        {{--                                            <div class="form-group">--}}
                                        ...
                                        <div class="form-group">
                                            <label for="exampleSelectGender">Institutions</label>
                                            <select class="form-control" id="exampleSelectGender" name="institution"  value="" required>
                                                <!-- Options will be dynamically populated here -->
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="recipient-name" name="color" value="{{$productDetails['color']}}"  required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">code:</label>
                                            <input type="text" class="form-control" id="recipient-name" name="code" value="{{$productDetails['code']}}"   required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">Descripton:</label>
                                    <textarea class="form-control" id="message-text" name="description" value="{{$productDetails['description']}}"  required></textarea>
                                </div>
