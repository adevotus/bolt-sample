...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active">
                <a href="/client-dashboard" class="nav-link"><i class="fas fa-fire"></i><span>Dashboard</span></a>
...
{{--            </li>--}}
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{route('product-list-client')}}">List</a></li>
                    <li><a class="nav-link" href="#">Report</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{route('orders-list-client')}}">List</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{route('payment-list-client')}}">Payment List</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
{{--                    <li><a href="#">Business Oweners</a></li>--}}
